#!/usr/bin/env python3
"""
Per-era style bible for vox-video-director (validated on Atlas Cloud / Nano Banana 2).
...
VIDEO_ASPECT_SUPPORT = {
    "happyhorse-1.1-i2v": ["16:9", "9:16", "1:1", "4:3", "3:4"],
    "happyhorse-1.0-video-edit": ["16:9", "9:16", "1:1", "4:3", "3:4"],
    "wan2.6": ["16:9", "9:16", "1:1", "4:3", "3:4"],
