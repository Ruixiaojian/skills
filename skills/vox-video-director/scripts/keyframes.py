...
IMAGE_MODEL = "google/nano-banana-2/text-to-image"  # Bailian provider maps legacy IDs
...
def run(project_dir):
    ...
    done = run_jobs(prov, specs, poll_s=3, stall_s=75, max_retries=2, deadline_s=900)
