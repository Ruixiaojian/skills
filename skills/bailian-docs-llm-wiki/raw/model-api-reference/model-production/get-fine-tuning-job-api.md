...
本次调优[任务的状态](https://help.aliyun.com/zh/model-studio/create-fine-tuning-job-api#2287fa490f9ga)。
...
要取消的调优任务ID，可通过[创建训练任务](https://help.aliyun.com/zh/model-studio/create-fine-tuning-job-api#t6612754.html)或列举训练任务接口获取。
...
要删除的调优任务ID，可通过[创建训练任务](https://help.aliyun.com/zh/model-studio/create-fine-tuning-job-api#t6612754.html)或列举训练任务接口获取。
