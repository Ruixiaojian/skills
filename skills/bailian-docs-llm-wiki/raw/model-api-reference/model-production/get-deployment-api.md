...
新模型的唯一标识，可通过[创建部署](https://help.aliyun.com/zh/model-studio/create-deployment-api#t6612768.html)或列举部署接口获取。
...
具体支持情况请参考：[模型单元部署的功能支持情况](https://help.aliyun.com/zh/model-studio/create-deployment-api#2fc096b2fdw9z)。

更新之后，模型所使用的资源单元。**必须**是`[base_capacity](https://help.aliyun.com/zh/model-studio/list-deployable-models-api#4d68826158yix)`的整数倍。
...
具体支持情况请参考：[PTU部署的功能支持情况](https://help.aliyun.com/zh/model-studio/create-deployment-api#2fc096b2fdw9z)。
